...
const faqs = [
  ...
  ['How do I contact Rexora Technologies?', 'Email rexoratechnologies@gmail.com or call +1 2402519611. You can also use the inquiry form below and the Rexora team will follow up.'],
];
